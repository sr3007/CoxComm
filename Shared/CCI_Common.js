    ...
    CanIManageLists: function () {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                permissions.initPropertiesFromJson(data.d.GetUserEffectivePermissions);
                //var permLevels = [];
...
$(document).ready(function () {
    ...
    if (inDesignMode == "1") {
        ...
        if (version === false) {
            ...
            console.log('i am in not in IE11');
        } else if (version >= 12) {
            $('meta[http-equiv="X-UA-Compatible"]').remove();
            $('head').prepend('<meta http-equiv="X-UA-Compatible" content="IE=Edge">');
            console.log('i am in greaterthan 12mode');
        } else {
            $('meta[http-equiv="X-UA-Compatible"]').remove();
            $('head').prepend('<meta http-equiv="X-UA-Compatible" content="IE=Edge">');
            console.log('i am in Last mode');
        }
    }
    /* Method to Display Welcome Message*/
    var interval = setInterval(function () {
        if ($('.o365cs-me-tileview').length || $('.o365cs-me-tile-nophoto').length) {
            //var userDisplayName = CCI_Common.GetUserFirstName();
            ...
            if ($('.o365cs-me-tile-nophoto').length) {
                $(".o365cs-me-tile-nophoto-username").replaceWith("Hi " + userDisplayName + "");
            }
    ...
    /*Clear Cache on User Signout*/
    /*$('#O365_SubLink_ShellSignout').on('click', function () {
...
//$( ".ms-dlgContent .ms-dlgTitleBtns .ms-dlgCloseBtn span" ).replaceWith( "<a class='popup-close' data-popup-close='popup-1' href='#'><i class='icon-cancel-1'></i></a>" );

/*Mobile Title enabled*/

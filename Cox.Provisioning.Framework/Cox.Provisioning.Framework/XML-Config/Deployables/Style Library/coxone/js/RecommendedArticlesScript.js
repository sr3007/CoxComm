        ...
        call.done(function (data, textStatus, jqXHR) {
            ...
            if (queryResults.length > 0) {
                ...
                for (var i = 0; i < queryResults.length; i++) {
                    ...
                    title +
                    "</h3></a><div class='box_accordian'><img  class='image_fit' src='" + pictureURL + "'/><div class='LikeSection'><a href='#' class='like'><span class='likecount' id='RecommendedNewslikecount" + itemId + "' onclick=\"javascript: LikeRecommended(" + itemId + ");\"></span><a href='#' id='RecommendedNewslikebutton" + itemId + "' class='LikeButton'  style='display:none;'></a></a></div> </div></div></div>";

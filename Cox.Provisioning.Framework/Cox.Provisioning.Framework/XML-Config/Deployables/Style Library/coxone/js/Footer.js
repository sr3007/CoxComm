(function () {
    ...
    function getSubMenus() {
				var def1 = $.Deferred();
									$.ajax({
											url: _spPageContextInfo.siteAbsoluteUrl + "/_api/web/lists/getbytitle('FooterMasterDetail')/Items?$select=Title,FooterMasterDetailUrl,FooterMasterTitleNew/Title&$expand=FooterMasterTitleNew&$orderby=FooterMasterDetailIsVisible&%20asc&$filter=FooterMasterDetailIsVisible%20eq%201",
											type: "GET",
											headers: {
												"Accept": "application/json; odata=verbose",
												"Content-Type": "application/json; odata=verbose",
    ...
    $(document).ready(function () {
		  ...
		  var restUrl = _spPageContextInfo.siteAbsoluteUrl + "/_api/web/lists/getbytitle('FooterMaster')/Items?$select=Title,Category,FooterUrl&$orderby=MenuOrderLevel%20asc&$filter=IsVisible%20eq%201";

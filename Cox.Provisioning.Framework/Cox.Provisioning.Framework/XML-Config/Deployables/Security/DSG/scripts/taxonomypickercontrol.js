...
(function (CAMControl) {
    ...
    $.extend(Term.prototype, {
        ...
        toHtmlLabel: function () {
            ...
            return $('<li class="cam-taxpicker-treenode-li"><div class="cam-taxpicker-treenode"><div class="cam-taxpicker-expander ' + addlClass + '"></div><img src="../Assets/DSG/styles/images/EMMTerm.png" alt=""/><span class="cam-taxpicker-treenode-title"  data-item="' + this.Name + '|' + this.Id + '">' + this.Name + '</span></div></li>');
        }
    });
    //********************** END Term Class **********************
    ...
    $.extend(TaxonomyPicker.prototype, {
        ...
        dialogNewTermClicked: function (event) {
            ...
            this._dlgNewNode = $('<li class="cam-taxpicker-treenode-li newNode"></li>').append($('<div class="cam-taxpicker-treenode"></div>').append('<div class="cam-taxpicker-expander"></div><img src="../Assets/DSG/styles/images/EMMTerm.png" alt=""/>').append(this._dlgNewNodeEditor));
        ...
        showPickerDialog: function (event) {
            ...
            if (!this.TermSet.TermsLoaded) {
                ...
                if (this._dialog == null) {
                    ...
                    //build dialog body
                    var dlgSubheader = $('<div class="cam-taxpicker-dialog-content-subheader"><img class="cam-taxpicker-dialog-content-subheader-img" src="../Assets/DSG/styles/images/EMMDoubleTag.png" alt="" /></div>');
                    ...
                    var root = $('<li class="cam-taxpicker-treenode-li"></li>').append($('<div class="cam-taxpicker-treenode"></div>').append('<div class="cam-taxpicker-expander expanded"></div>').append('<img src="../Assets/DSG/styles/images/EMMTermSet.png" alt=""/>').append(this._dlgCurrTermNode));

...
appWP.controller('ctrlMyWSDocuments', function ($scope) {
    ...
    function init() {
        ...
        $.getJSON(_spPageContextInfo.webServerRelativeUrl + "/_api/web/currentuser")            .done(function (data) {
                if (data != null && data.Title != null && typeof (data.Title) != "undefined") {
                    currentUserName = data.Title;
                    //https://mod174499.sharepoint.com/sites/CoxOne/_api/search/query?QueryText=%27(FileExtension:doc OR FileExtension:docx OR FileExtension:xls OR FileExtension:xlsx OR FileExtension:ppt OR FileExtension:pptx OR FileExtension:pdf)%27&amp;selectproperties=%27Title,Path,LastModifiedTime,FileType%27&amp;properties=%27GraphQuery:ACTOR(ME\,%20action\:1003)%27&sortlist='LastModifiedTime:descending'
                    var requestUri = _spPageContextInfo.siteAbsoluteUrl + "/_api/search/query?querytext=";
                    requestUri += "%27(FileExtension:doc OR FileExtension:docx OR FileExtension:xls OR FileExtension:xlsx OR FileExtension:ppt OR FileExtension:pptx OR FileExtension:pdf)%27";
                    requestUri += "&amp;selectproperties=%27Title,Path,LastModifiedTime,FileType%27";

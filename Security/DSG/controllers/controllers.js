...
(function () {
   ...
   function appCtrlr($scope, $timeout, $route) {
      ...
      function getUsersFromWS() {
          ...
          if (query != "" && restUrl != "") {
              $scope.statusMessages += "Searching for users...<br />";
              jQuery.ajax(
              {
                  url: restUrl,
                  type: "POST",
          ...
          /*            if (data.d.query.PrimaryQueryResult != null) {
                  ...
                  error: function (jqxr, errorCode, errorThrown) {
                      ...
                      var data = { "Table": [{ "Email": "QAUS23ER81@cox.com", "UserName": "qauser, eightyone" },  { "Email": "QAUSER85@coxcomminc.onmicrosoft.com", "UserName": "qauser, eightyfive" }, { "Email": "QAUSER81@coxcomminc.onmicrosoft.com", "UserName": "qauser, eightyone" }, { "Email": "QAUSER73@coxcomminc.onmicrosoft.com", "UserName": "qauser, seventythree" }] };
                      if (data != null) {
                          var results = data.Table;
                          var accountName = "";
                          var preferredName = "";
      ...
      function BuildQueryJSON() {
          ...
          if (vm.termsBusinessUnit.length > 0) {
              ...
              var qryFS = "";
              if ($scope.buSelectedOption == "==") { //Equal to
                  ddlSelection = "==";
              ...
              else if ($scope.buSelectedOption == "!=") { //Not equal to
                  ddlSelection = "!=";
              ...
              else if ($scope.buSelectedOption == ">") { //Greater than
                  ddlSelection = ">";
              ...
              else if ($scope.buSelectedOption == ">=") { //Greater than or equal to
                  ddlSelection = ">=";
              ...
              else if ($scope.buSelectedOption == "<") { //Less than
                  ddlSelection = "<";
              ...
              else if ($scope.buSelectedOption == "<=") { //Less than or equal to
                  ddlSelection = "<=";
      ...
      function AddUsersToGroup()
      {
          ...
          $.when.apply($, deferreds).always(function () {
              /*  $.each(deferreds, function (index, arg) {
              ...
              $.each(deferreds, function () {
                  ...
                  this.done(function () {
                      exeUsers++;
                      if (arguments.length == 1 && $scope.hideUsersList == false) {
                          //$scope.usersToAdd.push("  " + arguments[0]);
                          $scope.safeApply(function () {
                              $scope.hideUsersList = true;
                          });
                      }
                      ...
                      if (exeUsers == uniqueUPAUsers.length) {
                          AddtoDSGListREST();
                          if ($scope.usersToAdd.length > 0) {
                              $scope.safeApply(function () {
                                  //$scope.hideUsersList = true;

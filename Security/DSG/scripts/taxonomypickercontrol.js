...
(function (CAMControl) {
    ...
    $.extend(Term.prototype, {
        ...
        toHtmlLabel: function () {
            ...
            return $('<li class="cam-taxpicker-treenode-li"><div class="cam-taxpicker-treenode"><div class="cam-taxpicker-expander ' + addlClass + '"></div><img src="../SiteAssets/DSG/styles/images/EMMTerm.png" alt=""/><span class="cam-taxpicker-treenode-title"  data-item="' + this.Name + '|' + this.Id + '">' + this.Name + '</span></div></li>');
        }
    });
    //********************** END Term Class **********************
    ...
    $.extend(TermSet.prototype, {
        ...
        termsReload: function (termSetId) {
            //Get the taxonomy session using CSOM
            var taxSession = SP.Taxonomy.TaxonomySession.getTaxonomySession(spContext);
            //Use the default term store...this could be extended here to support additional term stores
            var termStore = taxSession.getDefaultSiteCollectionTermStore();
            ...
            //get the termset based on the properties of the termset
            if (termSetId != null)
                this.RawTermSet = termStore.getTermSet(termSetId); //get termset by id
            this.RawTerms = this.RawTermSet.getAllTerms();
            spContext.load(this.RawTermSet);
            spContext.load(this.RawTerms);
            spContext.executeQueryAsync(Function.createDelegate(this, this.termsLoadedSuccess), Function.createDelegate(this, this.termsLoadedFailed));
        ...
        termsLoadedFailed: function (event, args) {
            /*if (!this.TermSet.TermsLoaded) {
                this.TermSet.termsReload(this.TermSet.Id);
            }*/
            this.termsReload(this.Id);
    ...
    $.extend(TaxonomyPicker.prototype, {
        ...
        dialogNewTermClicked: function (event) {
            ...
            this._dlgNewNode = $('<li class="cam-taxpicker-treenode-li newNode"></li>').append($('<div class="cam-taxpicker-treenode"></div>').append('<div class="cam-taxpicker-expander"></div><img src="../SiteAssets/DSG/styles/images/EMMTerm.png" alt=""/>').append(this._dlgNewNodeEditor));
        ...
        showPickerDialog: function (event) {
            ...
            if (!this.TermSet.TermsLoaded) {
                ...
                if (this._dialog == null) {
                    ...
                    //build dialog body
                    var dlgSubheader = $('<div class="cam-taxpicker-dialog-content-subheader"><img class="cam-taxpicker-dialog-content-subheader-img" src="../SiteAssets/DSG/styles/images/EMMDoubleTag.png" alt="" /></div>');
                    ...
                    var root = $('<li class="cam-taxpicker-treenode-li"></li>').append($('<div class="cam-taxpicker-treenode"></div>').append('<div class="cam-taxpicker-expander expanded"></div>').append('<img src="../SiteAssets/DSG/styles/images/EMMTermSet.png" alt=""/>').append(this._dlgCurrTermNode));
